...
public:
  ...
  double getMean(); //Gets the arithmetic mean for the list.

  double getStdev(); //Gets the Population Standard Deviation for the list.

  AUList DuplicateNV(int N); //Duplicates the first N values of the list.
